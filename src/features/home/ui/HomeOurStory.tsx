      ...
      <div className="relative left-1/2 w-screen max-w-[100vw] -translate-x-1/2 overflow-visible">
        ...
        <div className="relative z-[1] mx-auto grid w-full max-w-[1338px] gap-10 px-5 lg:grid-cols-[minmax(0,821px)_minmax(0,390px)] lg:items-start lg:gap-[41px]">
          <div className="min-w-0 overflow-visible">
            ...
            <HomeStagger
              className="relative z-[1] mt-10 grid grid-cols-1 gap-5 overflow-visible sm:mt-12 sm:grid-cols-2 sm:gap-[41px]"
              stagger={0.1}
            >
              {/* White card — 22:333 */}
              <HomeStaggerItem>
              ...
              <HomeStaggerItem className="sm:col-span-2">
                <article
                  data-node-id="22:335"
                  className="relative z-[1] h-[182px] overflow-visible"
                >
                  <div
          ...
          <HomeReveal
            ...
            x={20}
            amount={0.15}
            className="lg:w-full lg:max-w-[390px] lg:justify-self-end"
          >
            <article
              data-node-id="22:336"
              className="relative z-[3] overflow-visible max-lg:min-h-[480px] lg:h-[787px]"
            >
