...
const EXPAND_EASE = "duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]";
    ...
    <div className="xl:hidden">
      <div className="flex items-center justify-between gap-3 pb-[9px] pt-0">
        ...
        <button
          ...
          className={`flex size-11 shrink-0 items-center justify-center rounded-full text-white transition-colors hover:bg-white/10 ${
            open ? "bg-white/10" : ""
          }`}
          aria-label={label}
          aria-expanded={open}
      ...
      <div
        className={`grid transition-[grid-template-rows,opacity] ${EXPAND_EASE} ${
          open
