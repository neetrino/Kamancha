...
ALTER TABLE "users" ADD CONSTRAINT "users_bonus_balance_nonneg_chk" CHECK ("users"."bonus_balance" >= 0);--> statement-breakpoint
...
ALTER TABLE "orders" ADD CONSTRAINT "orders_gift_card_amount_nonneg_chk" CHECK ("orders"."gift_card_amount" >= 0);
